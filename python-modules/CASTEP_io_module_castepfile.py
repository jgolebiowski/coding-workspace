...
class Castepfilefile:
	...
	def get_atomic_forces(self):
			...
			force_x = float(''.join(ele for ele in line.split()[3] if ele.isdigit() or ele =='.' or ele =='-'))
			force_y = float(''.join(ele for ele in line.split()[4] if ele.isdigit() or ele =='.' or ele =='-'))
			force_z = float(''.join(ele for ele in line.split()[5] if ele.isdigit() or ele =='.' or ele =='-'))
