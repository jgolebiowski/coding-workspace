...
class Cellfile:
	...
	def read_in_structure_class(self, structure):
		"""Get data from a structure"""
		self.atoms = structure.atom_list
		self.lattice_vec = structure.lattice_vectors
