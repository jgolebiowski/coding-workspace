...
class adaptiveSGD(object):
    ...
    def __init__(self,
        ...
        # self.gMatrix = np.ones((len(param0), len(param0))) * 1e-8
        ...
        self.trainingLabelsBatches = [self.trainingLabels[index: index + self.miniBatchSize]
                                      for index in self.miniBatchIndexList]
        self.func = function
        ...
        for indexE in range(self.epochs):
            ...
            for indexMB in range(self.nMiniBatches):
                ...
                cost = self.updateMiniBatch(self.params,
                                            self.trainingDataBatches[randBatchIndex],
                                            self.trainingLabelsBatches[randBatchIndex])
